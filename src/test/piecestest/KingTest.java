...
public class KingTest {
    ...
    public void testGetPossibleDestinationsWhiteClearBoard()
        ...
        testKing = (King) testGame.getPlayerWhite().getPieceAt(Column.E, 1);
        testKing.moveTo(testGame.getBoard().getTileAt(Column.D, 4));
        System.out.println();
        testGame.getBoard().printBoardWithPossibleDestinations(testKing
    ...
    public void testGetPossibleDestinationsWhiteClearBoardEdge()
        ...
        testGame.getBoard().clearBoard();
        testKing = (King) testGame.getPlayerWhite().getPieceAt(Column.E, 1);
        testKing.moveTo(testGame.getBoard().getTileAt(Column.A, 1));
        System.out.println();
        testGame.getBoard().printBoardWithPossibleDestinations(testKing);
    }
